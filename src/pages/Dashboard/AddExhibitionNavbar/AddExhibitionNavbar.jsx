    ...
    fetch(img_hosting_url, {
      ...
      .then(imgResponse => {
        if (imgResponse.success) { // Correct variable: `imgResponse`
          ...
          console.log(newItem);
          axiosSecure.post('/exhibitionNavbar', newItem)
            .then(data => {
    ...
    <>
      ...
      <div className='w-full p-10'>
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <input className='btn btn-sm mt-4 font-semibold' type="submit" value="Add Exhibition Navbar" />
        </form>
      </div>
    </>
  );
...
export default AddExhibitionNavbar;
