  ...
  return (
    <>
      ...
      <div className="flex flex-wrap md:flex-nowrap gap-3 md:gap-6 w-full lg:min-h-screen mt-20 md:mt-52 text-sm px-4 md:px-0 mb-12">
        ...
        {/* Right Section */}
        <div className="w-full md:w-1/2 md:mt-8 text-justify">
          <p>
            <span className="text-red-600 text-lg">a</span>rt
            <span className="text-red-600">s</span>ense is an organization dedicated to fostering the creation of contemporary visual art. Numerous barriers hinder an artist's entry into the art world, encompassing logistical challenges and marketing intricacies. We assume responsibility for a comprehensive array of tasks, ranging from negotiating with clients to facilitating pick-up and delivery, thereby offering a seamless system that enables artists to operate on a global scale while remaining situated within their own country. <span className="text-red-600 text-lg">a</span>rt
