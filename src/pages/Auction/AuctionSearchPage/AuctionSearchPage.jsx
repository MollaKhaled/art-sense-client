        ...
        <div className="lg:col-span-3 text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
            {searchResults.length > 0 ? (
              searchResults.map((photo) => <AuctionSearchCard key={photo._id} photo={photo} />)
            ) : (
              !loading &&  <p className="items-center justify-center">No results found for "{query || media || year || price}"</p>
            )}
          </div>
        </div>
      </div>
